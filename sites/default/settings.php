 ...
 * @endcode
 */
$settings['hash_salt'] = 'CYc7ky-FcmRgmsBjBdOItnxCdWnIWzPfv80mx-EdIjjkxFTl2mkIFJUNu8ZaqajX6AEjqBEFDQ';
...
$settings['config_sync_directory'] = 'sites/default/files/config_5_V2o608R2xio9F-v4FryWvKNMkGLRUiL9J0EDSsF9zBHkg2LD_u5NNvNspzCA_hlBGI3h6fyg/sync';

$settings['trusted_host_patterns'] = array(
  '^localhost$',
  '^127\.0\.0\.1$',
  '^example\.com$',         // Cambia 'example.com' por tu dominio
  '^www\.example\.com$',    // Cambia 'www.example.com' por tu dominio
);

$config['system.theme']['admin'] = 'mi_tema';  // Reemplaza 'mi_tema' con el nombre de tu tema
$databases['default']['default'] = array (
  'database' => 'drupal',
  'username' => 'drupal',
  'password' => 'drupal',
